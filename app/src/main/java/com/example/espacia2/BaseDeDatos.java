...
public class BaseDeDatos extends SQLiteOpenHelper {
    ...
    public void  insertDB(){
        ...
        values6.put(opciones, "Mar Caspio, Lago Superior, Lago Victoria");
        ...
        values7.put(respuestas, "Perú, Colombia, Brasil, Ecuador");
        values7.put(opciones, "Perú, Colombia, Brasil, Ecuador");
        ...
        values8.put(opciones, "Barcelona, Madrid, Valencia");
        ...
        values10.put(opciones, "Canadá, México, Estados Unidos");
        ...
        values11.put(opciones, "Ciudad de México, Guadalajara, Monterrey");
        ...
        values12.put(opciones, "Brasil, Argentina, Chile");
        ...
        values13.put(respuestas, "África");
        values13.put(opciones, "África, Asia, Europa");
        ...
        values14.put(opciones, "Océano Pacífico, Océano Atlántico, Océano Índico");
        ...
        values15.put(opciones, "Cordillera de los Andes, Himalayas, Alpes");
        ...
        values16.put(opciones, "África, Arabia, Australia");
        ...
        values17.put(opciones, "Río Nilo, Río Amazonas, Río Misisipi");
        ...
        values19.put(opciones, "Himalayas, Andes, Alpes");
        ...
        values20.put(opciones, "Antártida, Arabia, Australia");
        ...
        valuesDeporte1.put(opciones, "Real Madrid, FC Barcelona, Atlético Madrid");
        ...
        valuesDeporte2.put(opciones, "Michael Phelps, Usain Bolt, Carl Lewis");
        ...
        valuesDeporte3.put(respuestas, "Francia");
        ...
        valuesDeporte7.put(opciones, "New York Yankees, St. Louis Cardinals, San Francisco Giants");
        ...
        valuesDeporte10.put(opciones, "Real Madrid, FC Barcelona, Manchester United ");
        ...
        valuesDeporte11.put(opciones, "Brasil, Alemania, Italia ");
        ...
        valuesDeporte12.put(opciones, "Kareem Abdul-Jabbar, Michael Jordan, LeBron James");
        ...
        valuesDeporte13.put(opciones, "Ferrari, Mercedes, Red Bull Racing ");
        ...
        valuesDeporte14.put(opciones, "Roger Federer, Rafael Nadal, Novak Djokovic ");
        ...
        valuesDeporte15.put(opciones, "Nueva Zelanda, Sudáfrica, Australia ");
        ...
        valuesDeporte16.put(opciones, "Pittsburgh Steelers, San Francisco 49ers, New England Patriots ");
        ...
        valuesDeporte17.put(opciones, "Estados Unidos, Brasil, Cuba ");
        ...
        valuesDeporte18.put(opciones, "Rusia, Brasil, Italia ");
        ...
        valuesDeporte19.put(opciones, "Estados Unidos, China, Reino Unido ");
        ...
        valuesDeporte20.put(opciones, "Boston Celtics, Los Angeles Lakers, Chicago Bulls ");
        ...
        valuesHistoria1.put(opciones, "Augusto, Julio César, Nerón");
        ...
        valuesHistoria2.put(respuestas, "El asesinato del archiduque austriaco Francisco Fernando");
        valuesHistoria2.put(opciones, "El asesinato del archiduque austriaco Francisco Fernando, la competencia colonial, la rivalidad entre las potencias europeas");
        ...
        valuesHistoria3.put(opciones, "Adolf Hitler, Joseph Goebbels, Hermann Göring");
        ...
        valuesHistoria4.put(opciones, "George Washington, John Adams, Thomas Jefferson ");
        ...
        valuesHistoria5.put(opciones, "La crisis económica y financiera del reino, el malestar social, el descontento con la monarquía");
        ...
        valuesHistoria6.put(opciones, "Alfredo el Grande, Guillermo el Conquistador, Enrique VIII");
        ...
        valuesHistoria7.put(opciones, "Joseph Stalin, Leon Trotsky, Nikita Khrushchev");
        ...
        valuesHistoria8.put(opciones, "Mahatma Gandhi, Jawaharlal Nehru, Sardar Patel");
        ...
        valuesHistoria9.put(opciones, "El ataque de Alemania a Polonia, el Pacto de No Agresión entre Alemania y la Unión Soviética, la invasión de Japón a China");
        ...
        valuesHistoria10.put(opciones, "Romulo, Julio César, Nerón");
        ...
        valuesHistoria11.put(opciones, "El asesinato del archiduque austriaco Francisco Fernando, la competencia colonial, la rivalidad entre las potencias europeas");
        ...
        valuesHistoria12.put(opciones, "Vladimir Lenin, Joseph Stalin, Leon Trotsky");
        ...
        valuesHistoria13.put(opciones, "Napoleón Bonaparte, Louis XVIII, Charles X");
        ...
        valuesHistoria14.put(opciones, "George Washington, Thomas Jefferson, John Adams");
        ...
        valuesHistoria15.put(opciones, "Mao Zedong, Sun Yat-sen, Chiang Kai-shek");
        ...
        valuesHistoria16.put(opciones, "Gamal Abdel Nasser, Anwar Sadat, Hosni Mubarak");
        ...
        valuesHistoria17.put(opciones, "Mahatma Gandhi, Jawaharlal Nehru, Sardar Patel");
        ...
        valuesHistoria18.put(opciones, "El desarrollo de la máquina de vapor, el surgimiento de nuevas tecnologías, el aumento de la población urbana");
        ...
        valuesHistoria19.put(opciones, "Miguel Hidalgo y Costilla, José María Morelos, Vicente Guerrero");
        ...
        valuesHistoria20.put(opciones, "La Primera Guerra Mundial y la crisis económica, el malestar social, el descontento con el régimen zarista");
        ...
        valuesEntretenimiento1.put(opciones, "J.K. Rowling, Stephen King, George R.R. Martin");
        ...
        valuesEntretenimiento2.put(opciones, "Robert Downey Jr., Chris Evans, Chris Hemsworth");
        ...
        valuesEntretenimiento3.put(opciones, "David Yates, Chris Columbus, Alfonso Cuarón");
        ...
        valuesEntretenimiento4.put(opciones, "Benedict Cumberbatch, Robert Downey Jr., Jonny Lee Miller");
        ...
        valuesEntretenimiento5.put(opciones, "J.J. Abrams, George Lucas, Rian Johnson");
        ...
        valuesEntretenimiento6.put(opciones, "Daniel Craig, Sean Connery, Roger Moore");
        ...
        valuesEntretenimiento7.put(opciones, "George R.R. Martin, J.K. Rowling, Stephen King");
        ...
        valuesEntretenimiento8.put(opciones, "Peter Jackson, George Lucas, J.R.R. Tolkien");
        ...
        valuesEntretenimiento9.put(opciones, "Frank Darabont, Robert Kirkman, Greg Nicotero");
        ...
        valuesEntretenimiento10.put(opciones, "Vince Gilligan, Peter Gould, Mark Johnson");
        ...
        valuesEntretenimiento11.put(opciones, "Christian Bale, Michael Keaton, Val Kilmer");
        ...
        valuesEntretenimiento12.put(opciones, "Chuck Lorre, Bill Prady, Steven Molaro");
        ...
        valuesEntretenimiento13.put(opciones, "David Crane y Marta Kauffman, Kevin S. Bright y Marta Kauffman, David Crane y Kevin S. Bright ");
        ...
        valuesEntretenimiento14.put(opciones, "Ricky Gervais y Stephen Merchant, Greg Daniels, Ben Silverman ");
        ...
        valuesEntretenimiento15.put(opciones, "David Chase, Matthew Weiner, Terence Winter ");
        ...
        valuesEntretenimiento16.put(opciones, "David Simon, George Pelecanos, Ed Burns ");
